...
- ⚡ **过载模式**: 满级后再次拾取武器可触发 **Hyper Mode**，射速翻倍+金身特效。
- 🛡️ **纳米修复**: 引入呼吸回血机制，脱战 8 秒后自动缓慢修复机体。
...
| 图标 | 名称 | 效果 |
| :---: | :--- | :--- |
| <span style="color:#ef4444">P</span> | **Power Up** | 切换武器 / 提升当前武器等级 (20%几率连升2级) |
...
- **纳米修复**: 若 **8秒** 内未受到任何伤害，战机会启动纳米修复系统，缓慢回复生命值 (附带绿色光效)。
