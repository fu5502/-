...
import { Activity, Bomb, Trophy, Skull, RotateCcw, Crosshair, Zap, CircleDashed, ChevronRight, ChevronLeft, Play } from 'lucide-react';
    ...
    return (
      <div className="absolute inset-0 flex items-center justify-center bg-black/80 z-50 backdrop-blur-sm">
        <div className="relative w-full max-w-sm mx-4 p-8 border-2 border-blue-500/30 bg-gray-900/95 shadow-[0_0_50px_rgba(59,130,246,0.2)] flex flex-col items-center gap-6 rounded-xl overflow-hidden">
          ...
          <button 
            onClick={onStart}
            className="relative z-10 w-full group bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold py-4 px-6 rounded-lg shadow-lg transform transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 overflow-hidden"
          >
